...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi Normal        guifg=#dcdccc guibg=#3f3f3f           ctermfg=188 ctermbg=234
...
if exists("g:zenburn_old_Visual") && g:zenburn_old_Visual
    ...
    if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
        ...
        " low contrast
        hi Visual          guifg=#71d3b4 guibg=#838383 gui=none
        hi VisualNOS       guifg=#71d3b4 guibg=#838383 gui=none
    endif
endif
